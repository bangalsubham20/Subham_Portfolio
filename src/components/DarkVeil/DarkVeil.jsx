...
// Simplified shader for stability and performance
// The reference shader was very complex generated code (cppn_fn).
// We use a simpler moody shader here to ensure it works without errors.
